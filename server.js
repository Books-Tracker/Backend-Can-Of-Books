...
TODO://requiring the scheme and the model into your server

const {bookSchema} =require('./models/users.model');

const {bookModel} =require('./models/users.model');
...
const getbooks = async (req, res) => {
  ...
  bookModel.findOne({ email: email }, (err, user) => {
...
TODO//this seed function will be called whenever you want to populate the Database with data
